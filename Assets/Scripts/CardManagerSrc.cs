...
public class CardManagerSrc : MonoBehaviour
{
    ...
    {
        // Инициализация карт
        CardManager.AllCards.Add(new Card("Bull", "","Sprites/Cards/bull", 2, 9, 6));
        CardManager.AllCards.Add(new Card("Elephant", "","Sprites/Cards/elephant", 4, 3, 5));
        CardManager.AllCards.Add(new Card("Hyena", "","Sprites/Cards/hyena", 3, 3, 4));
        CardManager.AllCards.Add(new Card("Tiger", "","Sprites/Cards/tiger", 5, 5, 2));
        CardManager.AllCards.Add(new Card("Lion", "","Sprites/Cards/lion", 8, 2, 7));
